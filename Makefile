...
ifeq (,$(shell which ffmpeg))
	@echo "Could not install ffmpeg. Please install manually from https://ffmpeg.org"
endif
ifeq (,$(shell which unrar))
	@echo "Could not install unrar. Please install manually from https://www.rarlab.com/rar_add.htm"
endif
