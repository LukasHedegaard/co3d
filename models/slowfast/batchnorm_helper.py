...
# Modified from from https://github.com/facebookresearch/SlowFast
...
def get_norm(norm_type="batchnorm", num_splits=1):
    """
    Args:
    ...
    if norm_type == "batchnorm":
        ...
        return partial(SubBatchNorm3d, num_splits=num_splits)
